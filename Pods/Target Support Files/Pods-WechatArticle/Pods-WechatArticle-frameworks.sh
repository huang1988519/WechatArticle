...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-WechatArticle/JLToast.framework"
  install_framework "Pods-WechatArticle/Kingfisher.framework"
  install_framework "Pods-WechatArticle/Loggerithm.framework"
  install_framework "Pods-WechatArticle/MJRefresh.framework"
